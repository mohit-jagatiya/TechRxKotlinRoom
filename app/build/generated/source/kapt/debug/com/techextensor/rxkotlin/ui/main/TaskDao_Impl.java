...
public final class TaskDao_Impl implements TaskDao {
  ...
  public TaskDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfTask = new EntityInsertionAdapter<Task>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR ABORT INTO `Task` (`id`,`name`,`description`,`isCompleted`) VALUES (nullif(?, 0),?,?,?)";
      }
    ...
    this.__updateAdapterOfTask = new EntityDeletionOrUpdateAdapter<Task>(__db) {
      @Override
      public String createQuery() {
        return "UPDATE OR ABORT `Task` SET `id` = ?,`name` = ?,`description` = ?,`isCompleted` = ? WHERE `id` = ?";
      }
      ...
      public List<Task> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Task(_tmpId,_tmpName,_tmpDescription,_tmpIsCompleted);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public LiveData<List<Task>> getAllTasksAsLiveData() {
    final String _sql = "SELECT * FROM Task";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 0);
